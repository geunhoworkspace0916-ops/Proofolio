...
const variantClassNames: Record<ButtonVariant, string> = {
  primary:
    "bg-trust-600 text-white shadow-[0_1px_2px_rgba(11,18,32,0.08)] hover:bg-trust-500",
  secondary:
    "border border-ink-100 bg-paper-100 text-ink-900 shadow-[0_1px_2px_rgba(11,18,32,0.04)] hover:bg-paper-50 hover:text-ink-950",
  warning:
